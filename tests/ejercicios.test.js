...
const CON_PASOS = ['jerarquia', 'potencias', 'raices', 'enteros', 'divisibilidad', 'fracciones_equivalentes', 'suma_fracciones', 'producto_division_fracciones', 'decimales', 'expresiones_algebraicas', 'ecuaciones_primer_grado', 'proporcionalidad', 'porcentajes', 'perimetros_areas', 'teorema_pitagoras'];
