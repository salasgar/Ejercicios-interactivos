  ...
  app.innerHTML = `
    <section class="entrada">
      <div class="tarjeta">
        ...
        <p class="pequeno" style="text-align:center;margin:.5rem 0 0">Con la cuenta del centro (murciaeduca).</p>
        <div id="mensaje-google" class="aviso aviso--error" hidden></div>
      </div>
      <details class="tarjeta detalles-contrasena">
        <summary>Entrar con usuario y contraseña</summary>
        <form id="form-entrar" autocomplete="on" style="margin-top:.8rem">
          ...
          <button type="submit" class="ancho secundario" ${desactivado}>Entrar</button>
        </form>
      </details>
